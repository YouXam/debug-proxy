use debug_proxy::{ProxyConfig, SharedConfig, RequestRecorder, ProcessManager, RequestInfo, ResponseInfo};
...
fn test_shared_config_operations() {
    ...
    // Test read access
    assert_eq!(shared_config.get_upstream_timeout(), Duration::from_millis(200));
    ...
    assert_eq!(shared_config.get_upstream_timeout(), Duration::from_millis(300));
